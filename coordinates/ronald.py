...
def read_and_plot_points(filename, color):
  ...
  and plots them on a scatterplot with a specified color.

  Args:
      filename: The name of the text file containing the coor
  """
  points = []
  with open("coordinates_file.cvs", 'r') as file:
    for line in file:
